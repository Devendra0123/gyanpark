...
{ message &&  <div style={{opacity:"60%",zIndex:"9",position:"absolute",width:"100%",height:"100vh",backgroundColor:"grey"}}></div>}
                ...
                <form className={styles.signup_container_form} onSubmit={submitHandler}>
                   <div className={styles.signUpName}>
                      <div className={styles.faceIcon}>
                        <svg xmlns="http://www.w3.org/2000/svg" width="18px" height="18px" viewBox="0 0 14 14" aria-hidden="true" role="img"><path d="M7 8c-3.314 0-6 1.85-6 3.297v2.027c0 .373.358.676.8.676h10.4c.442 0 .8-.303.8-.676v-2.027C13 9.85 10.314 8 7 8zm3-5a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                      </div>
                      <input
