...
const UpdateQuestionPaper = () => {
  ...
  useEffect(()=>{
    ...
    if(level === "+2"){
        ...
        array = ["Dental Hygiene","Opthalmic science","Staff Nursing","Pharmacology Science","Lab technology"];
    }if(level === "Bachelor"){
        array = ["MBBS","BDS","BBS","Bsc. Nursing","BBA"]
    }
    ...
    const handleUpdate = async(e)=>{
      ...
      try{
        const {data} = await axios.post(
          '/api/question-paper/update-question-paper',                  
             {
              examId,
               program,
               programYear,
    ...
    return (
        <div className={styles.updateQuestionPaper}>
            <Navbar />
            <div className={styles.updateQuestionPaper_container}>
                ...
                <h4 className={styles.update_question_title}>
                   Update Question
                </h4>
                <form className={styles.form} onSubmit={handleUpdate}>
                  ...
                  <div>
                   <select className={styles.formSelect} onChange={(e) => setExamYear(e.target.value)}>
